...
export default function UpdateChangeLog() {
    ...
    const url: any = process.env.REACT_APP_API_URL + 'change-log/'+params.id !== undefined ? process.env.REACT_APP_API_URL + 'change-log/'+params.id : '';

    const [enteredTitle, setEnteredTitle] = useState('');

    const [enteredBody, setEnteredBody] = useState('');

    const [enteredPublished, setEnteredPublished] = useState('');
                ...
                <div className="new-entry">
                    <div className="ne-form">
                        <form onSubmit={addChangeLogHandler}>
                            ...
                            <div className="form-group">
                                <button className="btn blue" type="submit">Edit Change Log</button>
                            </div>
                        </form>
                    </div>
                </div>
