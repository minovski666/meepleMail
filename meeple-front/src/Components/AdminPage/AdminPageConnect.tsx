...
export default function AdminPageConnect() {
    const userObject = useContext(myContext) as IUser;

    const url: any = process.env.REACT_APP_API_URL + 'contacts' !== undefined ? process.env.REACT_APP_API_URL + 'contacts' : '';
